 ...
 * @author chenjing
 */
public class PickerOneView extends View {

    private final String TAG = PickerOneView.class.getSimpleName();
    /**
    ...
    public PickerOneView(Context context) {
        super(context);
        init();
    }

    public PickerOneView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
