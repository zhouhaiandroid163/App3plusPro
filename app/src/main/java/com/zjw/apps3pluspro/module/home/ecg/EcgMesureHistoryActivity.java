 ...
 * 心电测量历史
 */
public class EcgMesureHistoryActivity extends BaseActivity implements View.OnClickListener,
        CalendarView.OnCalendarSelectListener,
        CalendarView.OnMonthChangeListener,
        CalendarView.OnYearChangeListener {
    private final String TAG = EcgMesureHistoryActivity.class.getSimpleName();
    ...
    //列表
    private ListView ecg_mesure_history_list;
    ...
    protected int setLayoutId() {
        ...
        return R.layout.activity_ecg_mesure_history;
    }

    @Override
    protected void initViews() {
        super.initViews();
        mContext = EcgMesureHistoryActivity.this;
    ...
    private void initView() {
        ...
        public_head_title.setText(getResources().getString(R.string.ecg_measure_ecg));
        ...
        ecg_mesure_history_list = (ListView) findViewById(R.id.ecg_mesure_history_list);

        findViewById(R.id.ecg_history_to_measure).setOnClickListener(this);
    ...
    void initSetAdapter() {
        ...
        mEcgMesureHistoryListAdapter = new MesureHistoryListAdapter(mContext, MesureHistoryListAdapter.TYPE_ECG);
        ecg_mesure_history_list.setAdapter(mEcgMesureHistoryListAdapter);
        ecg_mesure_history_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent intent;
                if (mHealthInfo != null) {
                    intent = new Intent(mContext, EcgMesureDetailsActivity.class);
        ...
        //listView长按事件
        ecg_mesure_history_list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
...
//        registTime = "2019-05-09";
    ...
    void updateUi(List<HealthInfo> my_health_list) {
        ...
        if (my_health_list.size() > 0) {
            ecg_mesure_history_list.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            //跳转到测量
            case R.id.ecg_history_to_measure:
    ...
    void getHealthtDay(boolean is_cycle) {
        List<HealthInfo> health_list = mHealthInfoUtils.queryToDate(BaseApplication.getUserId(), selectionDate, true);
    ...
    private void ResultDataParsing(HealthBean mHealthBean, String date) {
        ...
        if (mHealthBean.getData().getHealthList().size() >= 1) {
            ...
            health_list.add(HealthBean.getEcgHealthNullInfo(date));
...
//
     ...
     * @param isCalibration
     */
    void gotoEcgMeasure(boolean isCalibration) {
