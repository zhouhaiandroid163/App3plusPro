...
//    final String FILE_PATH = SDCARD + "RtkLocalFileV2.3.8.bin";
//    final String FILE_PATH = SDCARD + "RtkLocalFile.bin";
//    final String FILE_PATH = SDCARD + "R11_3.6.bin";
//    final String FILE_PATH = SDCARD + "R11_3.7.bin";
//    final String FILE_PATH = SDCARD + "Theme_Test.bin";
//    final String FILE_PATH = SDCARD + "R10_V4.5.bin";
//    final String FILE_PATH = SDCARD + "R11_V4.2.bin";
//    final String FILE_PATH = SDCARD + "R11_V4.3.bin";
//    final String FILE_PATH = SDCARD + "R11_V4.4.bin";
//    final String FILE_PATH = SDCARD + "R10_V4.8.bin";
//    final String FILE_PATH = SDCARD + "R10_V1.5.1.bin";
//    final String FILE_PATH = SDCARD + "R11_V10003.5.2.bin";
//    final String FILE_PATH = SDCARD + "R11_V10003.5.3.bin";
//    final String FILE_PATH = SDCARD + "R11_V10003.5.4.bin";
//    final String FILE_PATH = SDCARD + "R11_V10003.5.5.bin";
//    final String FILE_PATH = SDCARD + "R11_V10003.6.1.bin";
//    final String FILE_PATH = SDCARD + "R10_H6_V10004.5.6.bin";
//    final String FILE_PATH = SDCARD + "R10_V10004.5.8.bin";
//    final String FILE_PATH = SDCARD + "R10_H6_V10004.6.1.bin";
//    final String FILE_PATH = SDCARD + "TTTTT.bin";
//    final String FILE_PATH = SDCARD + "R10_H6_10011_v6.8_200221.bin";
//    final String FILE_PATH = SDCARD + "R21_H6_10011_v6.6_200310.bin";
    final String FILE_PATH = SDCARD + "R11_FBT_CK78_10003_6.1.bin";
...
//            ZLogger.e(e.toString())
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = RtkLocalDfuActivity.this;
...
//                ProgressDialog.THEME_HOLO_LIGHT); // 进度条，在下载的时候实时更新进度，提高用户友好度
//        progressDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
//        progressDialog.setProgressDrawable(getResources().getDrawable(
//                R.drawable.progressbar_updatadialog));
//        progressDialog.setTitle(getString(R.string.download_title));
//        progressDialog.setMessage(getString(R.string.loading0));
...
//        filter.addAction(BleConstant.ACTION_UPDATE_DEVICE_FILE_STATE_SUCCESS);
...
//            switch (action) {
//
//                case BleConstant.ACTION_UPDATE_DEVICE_FILE_STATE_SUCCESS:
//
