...
public class DeviceHelpActivity extends Activity implements View.OnClickListener {
    private final String TAG = DeviceHelpActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = DeviceHelpActivity.this;
    ...
    private void initView() {
        ((TextView) findViewById(R.id.public_head_title)).setText(getText(R.string.privacy_protocol_title));
