...
public class UserHelpActivity extends Activity implements View.OnClickListener {
    private final String TAG = UserHelpActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = UserHelpActivity.this;
    ...
    private void initView() {
        ((TextView) findViewById(R.id.public_head_title)).setText(getString(R.string.app_healp));
...
//        wv_privacy_protocol.loadUrl("http://www.wearheart.cn/yinsi_FFit_zh.html");
//        wv_privacy_protocol.loadUrl("http://www.wearheart.cn/questionList.html");
//        wv_privacy_protocol.loadUrl("http://www.wearheart.cn/yinsi_FFit_en.html");

        if (AppUtils.isZh(mContext)) {
            wv_privacy_protocol.loadUrl("http://www.wearheart.cn/questionList_zh.html");
        }
        else {
            wv_privacy_protocol.loadUrl("http://www.wearheart.cn/questionList_en.html");
        }
