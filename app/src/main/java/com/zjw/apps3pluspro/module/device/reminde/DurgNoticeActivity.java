...
public class DurgNoticeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView tv_medicine_start_time, tv_medicine_time_bar, tv_medicine_end_time, tv_medicine_cycle, tv_medicine_hours;
    private TextView tv_medicine_title_time, tv_medicine_title_cycle;
    private RelativeLayout rl_medicine_cycle, rl_medicine_time;
    ...
    protected void initViews() {
        super.initViews();
        mContext = DurgNoticeActivity.this;
        initView();
        initData();
        updateUI();
    }
    ...
    void initView() {
        tv_medicine_cycle = (TextView) findViewById(R.id.tv_medicine_cycle);
        tv_medicine_hours = (TextView) findViewById(R.id.tv_medicine_hours);

        tv_medicine_start_time = (TextView) findViewById(R.id.tv_medicine_start_time);
        tv_medicine_time_bar = (TextView) findViewById(R.id.tv_medicine_time_bar);
        tv_medicine_end_time = (TextView) findViewById(R.id.tv_medicine_end_time);


        tv_medicine_title_time = (TextView) findViewById(R.id.tv_medicine_title_time);
        tv_medicine_title_cycle = (TextView) findViewById(R.id.tv_medicine_title_cycle);


        rl_medicine_cycle = (RelativeLayout) findViewById(R.id.rl_medicine_cycle);
        rl_medicine_time = (RelativeLayout) findViewById(R.id.rl_medicine_time);

        rl_medicine_cycle.setOnClickListener(this);
        rl_medicine_time.setOnClickListener(this);

        sb_notice_durg = (SwitchCompat) findViewById(R.id.sb_notice_durg);
        sb_notice_durg.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {

                mDurgModel.setMedicineEnable(isChecked);
                updateUI();
    ...
    void initData() {
        ...
        mDurgModel = RemindeUtils.getDurgModel();


    }

    void updateUI() {
        MyLog.i(TAG, "updateUI = mDurgModel = " + mDurgModel.toString());

        tv_medicine_cycle.setText(String.valueOf(mDurgModel.getMedicineCycleTime()));
        tv_medicine_start_time.setText(mDurgModel.getStartTime());
        tv_medicine_end_time.setText(mDurgModel.getEndTime());
        sb_notice_durg.setChecked(mDurgModel.isMedicineEnable());

        if (mDurgModel.isMedicineEnable()) {
            rl_medicine_cycle.setVisibility(View.VISIBLE);
            rl_medicine_time.setVisibility(View.VISIBLE);

            tv_medicine_start_time.setTextColor(getResources().getColor(R.color.white));
            tv_medicine_time_bar.setTextColor(getResources().getColor(R.color.white));
            tv_medicine_end_time.setTextColor(getResources().getColor(R.color.white));
            tv_medicine_cycle.setTextColor(getResources().getColor(R.color.white));
            tv_medicine_hours.setTextColor(getResources().getColor(R.color.white));

            tv_medicine_title_time.setTextColor(getResources().getColor(R.color.white));
            tv_medicine_title_cycle.setTextColor(getResources().getColor(R.color.white));

        } else {
            rl_medicine_cycle.setVisibility(View.GONE);
            rl_medicine_time.setVisibility(View.GONE);

            tv_medicine_start_time.setTextColor(getResources().getColor(R.color.white_50));
            tv_medicine_time_bar.setTextColor(getResources().getColor(R.color.white_50));
            tv_medicine_end_time.setTextColor(getResources().getColor(R.color.white_50));
            tv_medicine_cycle.setTextColor(getResources().getColor(R.color.white_50));
            tv_medicine_hours.setTextColor(getResources().getColor(R.color.white_50));

            tv_medicine_title_time.setTextColor(getResources().getColor(R.color.white_50));
            tv_medicine_title_cycle.setTextColor(getResources().getColor(R.color.white_50));
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.public_no_bg_head_back:
                finish();
                break;
            case R.id.rl_medicine_cycle:
                showNofifaceSectionDialog();
                break;
            case R.id.rl_medicine_time:
...
//                }
    ...
    private void showNofifaceSectionDialog() {
        ...
        start_hour = mDurgModel.getMedicineStartHourTime();
        start_min = mDurgModel.getMedicineStartMinTime();
        end_hour = mDurgModel.getMedicineEndHourTime();
        end_min = mDurgModel.getMedicineEndMinTime();
        ...
        view.findViewById(R.id.tv_notiface_section_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDurgModel.setMedicineStartHourTime(start_hour);
                mDurgModel.setMedicineStartMinTime(start_min);
                mDurgModel.setMedicineEndHourTime(end_hour);
                mDurgModel.setMedicineEndMinTime(end_min);
    ...
    private void showNofifaceCycleDialog() {
        ...
        cycle = mDurgModel.getMedicineCycleTime();
        ...
        view.findViewById(R.id.tv_notiface_cycle_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDurgModel.setMedicineCycleTime(cycle);
    ...
    void InputErrorDialog() {
        ...
        new AlertDialog.Builder(DurgNoticeActivity.this)
    ...
    void saveSetting() {
        ...
        RemindeUtils.setDurgModel(mDurgModel);
