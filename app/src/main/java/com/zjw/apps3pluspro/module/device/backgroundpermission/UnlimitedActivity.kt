...
import kotlinx.android.synthetic.main.unlimited_activity.*
import org.json.JSONObject

class UnlimitedActivity : BaseActivity() {
    private val TAG = UnlimitedActivity::class.java.simpleName
    override fun setLayoutId(): Int {
        return R.layout.unlimited_activity
    }
    ...
    override fun initViews() {
        ...
        val mRequestInfo = RequestJson.getSystemPermissionImageUrl("2", "1")
