...
import kotlinx.android.synthetic.main.power_management_activity.*
import kotlinx.android.synthetic.main.public_head.*
import org.json.JSONObject

class PowerManagementActivity : BaseActivity() {
    private val TAG = PowerManagementActivity::class.java.simpleName

    override fun setLayoutId(): Int {
        return R.layout.power_management_activity
    }
    ...
    override fun initViews() {
        ...
        val mRequestInfo = RequestJson.getSystemPermissionImageUrl("5", "2")
