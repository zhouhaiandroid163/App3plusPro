    ...
    public static RequestInfo postRecordPointList(List<SportModleInfo> sportModleInfoList) {
        ...
        try {
            ...
            for (int i = 0; i < sportModleInfoList.size(); i++) {
                ...
                mJSONObject.put("reportFastSpeed", SysUtils.bigDecimalFormat(mSportModleInfo.getReportFastSpeed()));
                ...
                mJSONObject.put("reportTrainingEffect", SysUtils.bigDecimalFormat(mSportModleInfo.getReportTrainingEffect()));
